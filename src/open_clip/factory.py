...
from .model import CLIP, CustomTextCLIP, CustomCLIP, convert_weights_to_lp, convert_to_custom_text_state_dict,\
    resize_pos_embed, get_cast_dtype, resize_text_pos_embed, set_model_preprocess_cfg
from .coca_model import CoCa
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, MultiClassLoss
...
def create_model_and_transforms(
        ...
        cache_dir: Optional[str] = None,
        output_dict: Optional[bool] = None,
        text_adapter_ratio: float = 0.0,
        visual_adapter_ratio: float = 0.0,
        class_names=None,
        **model_kwargs,
):
    ...
    model = CustomCLIP(model, class_names, tokenizer).to(device)
