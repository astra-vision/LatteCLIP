...
from torchvision.transforms import Normalize, Compose, RandomResizedCrop, InterpolationMode, ToTensor, Resize, \
    CenterCrop, ColorJitter, Grayscale, GaussianBlur
...
class gaussian_blur(object):
    ...
    def __init__(self, kernel_size):
        self.transf = GaussianBlur(kernel_size=kernel_size)
...
def image_transform(
    ...
    if is_train:
        ...
        if use_timm:
            ...
            if aug_cfg.gaussian_blur_kernel_size:
                train_transform.extend([
                    gaussian_blur(aug_cfg.gaussian_blur_kernel_size)
                ])
            train_transform.extend([
                ToTensor(),
                normalize,
