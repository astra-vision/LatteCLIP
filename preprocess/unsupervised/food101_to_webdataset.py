...
@click.command()
@click.option("--dataset_dir", default="$LATTECLIP_DATA_DIR/food-101")
@click.option("--preprocess_dir", default="$LATTECLIP_DATA_DIR/food101_preprocess")
...
Convert caltech-101 dataset to WebDataset format using the image ID - product title mapping. 
    ...
    split_path = os.path.join(dataset_dir, "split_zhou_food101.json")
